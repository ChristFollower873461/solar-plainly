...
Customer purchases a 9.6 kW DC photovoltaic system for a total financed amount of $42,900. The estimated cash price is $31,500. Estimated first-year production is 13,800 kWh. The loan term is 25 years at 3.99% APR. This sample is fictional and is provided for product demonstration only.`,
  },
  {
    number: 2,
    text: `PAYMENTS AND TAX ASSUMPTIONS
The initial payment assumes that the customer makes a voluntary prepayment equal to the anticipated federal tax credit within 18 months. If that prepayment is not made, the monthly payment will increase. Tax incentives are not guaranteed and depend on individual eligibility. Customer should consult a qualified tax professional.`,
  },
  {
    number: 3,
